...
import com.mibanco.es.clienteCDTDigital.gen.type.CiudadEnum;
import com.mibanco.es.clienteCDTDigital.gen.type.ClienteBaseType;
import com.mibanco.es.clienteCDTDigital.gen.type.DepartamentoEnum;
import com.mibanco.es.clienteCDTDigital.gen.type.GeneroEnum;
import com.mibanco.es.clienteCDTDigital.gen.type.SectorEconomicoEnum;
import com.mibanco.es.clienteCDTDigital.gen.type.TipoActividadCIIUEnum;
...
public class ClienteCDTDigitalType   {
  ...
  private @Valid Integer nivelConsulta;
  ...
  private @Valid SectorEconomicoEnum sectorEconomico;
  ...
  private @Valid Float ingresosMensuales;
  private @Valid Float patrimonio;
  ...
  private @Valid Date fechaClasificacionFatca;
  private @Valid String clasificacionCRS;
  private @Valid Date fechaClasificacionCRS;
  ...
  /**
   **/
  public ClienteCDTDigitalType telefonoPrincipal(Integer telefonoPrincipal) {
  ...
  /**
   **/
  public ClienteCDTDigitalType nivelConsulta(Integer nivelConsulta) {
  ...
  /**
   **/
  public ClienteCDTDigitalType sectorEconomico(SectorEconomicoEnum sectorEconomico) {
  ...
  public SectorEconomicoEnum getSectorEconomico() {
    return sectorEconomico;
  }

  @JsonProperty("sectorEconomico")
  public void setSectorEconomico(SectorEconomicoEnum sectorEconomico) {
    this.sectorEconomico = sectorEconomico;
  }
  ...
  /**
   **/
  public ClienteCDTDigitalType fechaClasificacionFatca(Date fechaClasificacionFatca) {
  ...
  public Date getFechaClasificacionFatca() {
    return fechaClasificacionFatca;
  }

  @JsonProperty("fechaClasificacionFatca")
  public void setFechaClasificacionFatca(Date fechaClasificacionFatca) {
    this.fechaClasificacionFatca = fechaClasificacionFatca;
  }
  ...
  /**
   **/
  public ClienteCDTDigitalType fechaClasificacionCRS(Date fechaClasificacionCRS) {
  ...
  public Date getFechaClasificacionCRS() {
    return fechaClasificacionCRS;
  }

  @JsonProperty("fechaClasificacionCRS")
  public void setFechaClasificacionCRS(Date fechaClasificacionCRS) {
    this.fechaClasificacionCRS = fechaClasificacionCRS;
  }
